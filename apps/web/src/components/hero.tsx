function Hero() {
  return (
    <div className="bg-gradient-to-br from-sky-500 to-indigo-500 text-white pt-16">
      <div className="container mx-auto flex flex-col items-center justify-between flex-wrap px-3 md:flex-row">
        {/* left col */}
        <div className="flex flex-col w-full justify-center items-start md:w-2/5 text-center md:text-left">
          <p className="capitalize tracking-wide w-full">
            Explore insights, events, and stories for curious minds like yours
          </p>

          <h2 className="capitalize my-5 text-5xl font-bold leading-tight">
            Welcome to ink nest Blog
          </h2>
